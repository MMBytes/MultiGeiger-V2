...
- (CI deprecation) Workflow `env: FORCE_JAVASCRIPT_ACTIONS_TO_NODE24=true` — opts every JS-based action (`checkout`, `upload-artifact`, `esp-idf-ci-action`) into Node.js 24 before the 2026-06-02 forced-default cutoff. Drop the env var once Node 24 is the runner default.
